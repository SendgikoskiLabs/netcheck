...
Changelog:
  v4.0 - Renamed tool from sendgikoski_netcheck.py to netcheck.py
         Migrated to new SendgikoskiLabs/netcheck repository
         Integrated sendgikoskilabs_core shared library as foundation
         Archived SendgikoskiLabs/netcheck_v3 (preserved for reference)
...
Run:
  python netcheck.py                            # launch GUI
  python netcheck.py ping google.com            # ping
  python netcheck.py ping google.com -c 10      # 10-packet ping
  python netcheck.py check google.com           # full diagnostic
  python netcheck.py traceroute google.com      # traceroute
  python netcheck.py all                        # check all default hosts
  python netcheck.py monitor                    # continuous monitor
  python netcheck.py monitor --influx           # monitor + InfluxDB export
  python netcheck.py monitor --hosts github.com cloudflare.com    # specify hosts
  python netcheck.py --help
"""
...
def launch_gui():
    ...
    about_text = [
        ...
        ("CLI USAGE\n", "subhead"),
        (
            "  python netcheck.py                          # this GUI\n"
            "  python netcheck.py ping google.com          # ping\n"
            "  python netcheck.py ping google.com -c 10    # 10-packet ping\n"
            "  python netcheck.py check google.com         # full check\n"
            "  python netcheck.py traceroute HOST          # traceroute\n"
            "  python netcheck.py all                      # check all default hosts\n"
            "  python netcheck.py monitor                  # live continuous monitor\n"
            "  python netcheck.py monitor --influx         # live monitor + InfluxDB export\n"
            "  python netcheck.py monitor --hosts github.com cloudflare.com    # specify hosts\n"
            "  python netcheck.py --help                   # full help\n\n",
            "accent",
        ),
        ("DEPENDENCIES\n", "subhead"),
        (
